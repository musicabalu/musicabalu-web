  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <UserAnalyticsSection 
        title="Analíticas por Familia (Clases presenciales)" 
        icon="👤"
        usersList={familiasData}
        selectedEmail={selectedUserEmail}
        setSelectedEmail={setSelectedUserEmail}
        emptyText="-- Selecciona una familia --"
      />

      <UserAnalyticsSection 
        title="Analíticas por Alumno (Formaciones)" 
        icon="🎓"
        usersList={formacionesData}
        selectedEmail={selectedFormacionEmail}
        setSelectedEmail={setSelectedFormacionEmail}
        emptyText="-- Selecciona un correo de formación --"
      />
