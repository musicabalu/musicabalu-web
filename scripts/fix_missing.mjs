...
async function main() {
  const enrollmentIds = [
    'cmtkmbw6m0002hekl43bny1rq', // Antonio
    'cmtkk58cx0001t7gee00tbsf0', // Alma
    'cmtmggwvy00011buiu7yumxfp'  // Álvaro (el más reciente)
  ];
  ...
  for (const id of enrollmentIds) {
    ...
    console.log(`Activada y correos enviados para: ${enrollment.childName}`);
  }

  // Borramos la matrícula antigua de Álvaro
  await prisma.enrollment.delete({
    where: { id: 'cmtlny5bl0002wd2s7zzydjh0' }
  });
  console.log("Matrícula antigua de Álvaro eliminada con éxito.");
